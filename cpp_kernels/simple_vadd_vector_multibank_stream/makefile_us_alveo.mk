...
TRACE_FLAGS := --profile.data=all:all:all
VPP_PFLAGS := 
...
CONN_FLAGS := --connectivity.sp krnl_vadd_1.in1:HBM[0:3] --connectivity.sp krnl_vadd_1.in2:HBM[4:7] --connectivity.sp krnl_vadd_1.out:HBM[8:11]
EXECUTABLE = ./simple_vadd_vector_multibank_stream
...
$(BUILD_DIR)/krnl_vadd.xclbin: $(TEMP_DIR)/krnl_vadd.xo
	mkdir -p $(BUILD_DIR)
	v++ -l $(TRACE_FLAGS) $(CONN_FLAGS) $(VPP_FLAGS) $(VPP_LDFLAGS) -t $(TARGET) --platform $(PLATFORM) --temp_dir $(TEMP_DIR) -o'$(LINK_OUTPUT)' $(+)
